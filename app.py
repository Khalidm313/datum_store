...
# -------------------------
# DATABASE INITIALIZATION (Fixes "no such table" error)
# -------------------------
with app.app_context():
    ...
    if not User.query.filter_by(username="admin").first():
        ...
        # Add shop for admin
        admin_shop = Shop(name="Datum Admin", user_id=admin.id, phone="0900000000")
        db.session.add(admin_shop)
        db.session.commit()
        print("✅ Database tables created and Admin user initialized.")
